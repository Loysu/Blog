...
class Post(models.Model):
    ...
    title = models.CharField(
        max_length=127, verbose_name="Название", db_index=True, unique=True
    )
    ...
    author = models.ForeignKey(
        "Profile", verbose_name="Автор", on_delete=models.PROTECT
    )
...
class Profile(models.Model):
    ...
    bio = models.CharField(
        max_length=511, verbose_name="Краткая информация об авторе", blank=True
    )
